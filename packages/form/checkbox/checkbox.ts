...
import { checked, prevent } from "@spark";
...
class Checkbox extends Echo(Hidden(HTMLElement)) {
  #controller;
  #element;
  #internals;
  ...
  @attributeChanged("checked", truthy)
  @around(validatable)
  @around(reflectable)
  set checked(value) {
  ...
  [dispatch]() {
    const init = { bubbles: true, cancelable: true, detail: this.checked };
